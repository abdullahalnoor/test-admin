    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item @if(request()->url() ==  route('admin.category.index')  ) 
                    menu-open
                    @elseif(request()->url() == route('admin.category.create') ) 
                    menu-open
                  @endif">
            <a href="#" class="nav-link @if(request()->url() ==  route('admin.category.index')  ) 
                    active
                    @elseif(request()->url() == route('admin.category.create') ) 
                    active
                  @endif">
          ...
          <li class="nav-item @if(request()->url() ==  route('admin.product.index')  ) 
                    menu-open
                    @elseif(request()->url() == route('admin.product.create') ) 
                    menu-open
                  @endif">
            <a href="#" class="nav-link @if(request()->url() ==  route('admin.product.index')  ) 
                    active
                    @elseif(request()->url() == route('admin.product.create') ) 
                    active
                  @endif">
